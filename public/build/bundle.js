    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$2, 26, 1, 363);
    			attr_dev(div, "class", "LinksButtons");
    			add_location(div, file$2, 25, 0, 335);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "profile-picture svelte-i6657v");
    			add_location(img, file$1, 17, 1, 191);
    			attr_dev(div, "class", "ProfilePicture");
    			add_location(div, file$1, 16, 0, 161);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br, file, 33, 3, 881);
    			add_location(p, file, 31, 2, 863);
    			attr_dev(div, "class", "containerCentre svelte-vl45gg");
    			add_location(div, file, 28, 1, 794);
    			attr_dev(body, "class", "svelte-vl45gg");
    			add_location(body, file, 27, 0, 786);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
